...
// --- MODEL CONFIGS with corrected model names ---
export const MODEL_CONFIGS = {
  // OpenAI Models
  'openai/gpt-4o': { provider: 'openai' as ProviderType, quality: 10, latency: 7, cost: { input: 5.00, output: 15.00 } },
  'openai/gpt-4-turbo-preview': { provider: 'openai' as ProviderType, quality: 9, latency: 6, cost: { input: 10.00, output: 30.00 } }, // Replaced gpt-4-turbo
  ...
  // Anthropic Models
  'anthropic/claude-3-5-sonnet-20240620': { provider: 'anthropic' as ProviderType, quality: 10, latency: 7, cost: { input: 3.00, output: 15.00 } },
  ...
  'anthropic/claude-3-5-haiku-20241022': { provider: 'anthropic' as ProviderType, quality: 8, latency: 10, cost: { input: 1.00, output: 5.00 } },
  ...
  // Mistral Models
  'mistral/mistral-large-latest': { provider: 'mistral' as ProviderType, quality: 9, latency: 6, cost: { input: 4.00, output: 12.00 } },
...
export const DEFAULT_ROUTING_RULES: Record<PromptType, Record<RoutingPriority, ModelName[]>> = {
  ...
  code_generation: {
    ...
    quality: ['openai/gpt-4-turbo-preview', 'anthropic/claude-3-opus-20240229', 'togetherai/Qwen/Qwen2.5-72B-Instruct'],
  },
  summarization: {
    cost: ['anthropic/claude-3-haiku-20240307', 'google/gemini-1.5-flash-latest', 'openai/gpt-3.5-turbo'],
    latency: ['google/gemini-1.5-flash-latest', 'anthropic/claude-3-5-haiku-20241022', 'openai/gpt-4o-mini'],
    quality: ['openai/gpt-4-turbo-preview', 'anthropic/claude-3-5-sonnet-20240620', 'google/gemini-1.5-pro-latest'],
  },
  qa_simple: {
    cost: ['google/gemini-1.5-flash-latest', 'anthropic/claude-3-haiku-20240307', 'openai/gpt-3.5-turbo'],
    latency: ['google/gemini-1.5-flash-latest', 'anthropic/claude-3-5-haiku-20241022', 'openai/gpt-4o-mini'],
  ...
  qa_complex: {
    ...
    quality: ['openai/gpt-4-turbo-preview', 'anthropic/claude-3-opus-20240229', 'google/gemini-1.5-pro-latest'],
  },
  creative_writing: {
    cost: ['anthropic/claude-3-haiku-20240307', 'mistral/open-mixtral-8x7b', 'openai/gpt-4o-mini'],
    latency: ['anthropic/claude-3-5-haiku-20241022', 'google/gemini-1.5-flash-latest', 'openai/gpt-4o'],
    quality: ['anthropic/claude-3-opus-20240229', 'openai/gpt-4-turbo-preview', 'mistral/mistral-large-latest'],
  },
  analysis: {
